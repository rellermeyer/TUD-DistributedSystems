...
case class MultiExe() extends FlatSpec with Matchers {
  ...
  "Test for one orderer 4 executors different applications" should "test past" in {
    ...
    for (i <- 1 to (TransactionNumber/3) by 1) {
      ...
      val t3 = new Transaction(i ,Operation.transfer, "a", Some("c"), immutable.Seq[String]("a"),
        immutable.Seq[String]("a", "c"), transferamount * 10, Application.C)
      var transactionMessage3 = RequestMessage(t3, 0, "cl1", orderers.head)
      val t4 = new Transaction(i, Operation.transfer, "a", Some("d"), immutable.Seq[String]("a"),
        immutable.Seq[String]("a", "d"), transferamount * 10, Application.D)
    ...
    timecounting(time1, time2, Executornumber, Ordernumber, TransactionNumber,0)
  }

  "Test for one orderer 7 executor, different applications " should "test past" in {
    ...
    for (i <- 1 to (TransactionNumber/6) by 1) {
      ...
      val t7 = new Transaction(i, Operation.transfer, "e", Some("g"), immutable.Seq[String]("e"),
        immutable.Seq[String]("e", "g"), transferamount * 10, Application.F)
      var transactionMessage7 = RequestMessage(t7, 0, "cl1", orderers.head)
      val t8 = new Transaction(i, Operation.transfer, "e", Some("h"), immutable.Seq[String]("e"),
        immutable.Seq[String]("e", "h"), transferamount * 10, Application.G)
