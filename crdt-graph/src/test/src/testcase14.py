# testcase 14: Add v1 on node 1, Add arc (v1, v2) on node 1 + remove v1 on node 2, lookup v1 on node 1
...
r1 = requests.get(url + node1_port + lookupvertex_endpoint, json=vertex1)
print(r1.text)
